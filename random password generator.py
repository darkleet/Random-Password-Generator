...
import random
str='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789@$&*!%_+='  #Wide variety of characters as well as symbols to choose from to ensure a strong password.
pwd=''
